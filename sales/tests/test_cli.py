...
from sales.app.cli import build_parser, main
...
class TestDispatch:
    def test_replay_notification_enqueues_task(self, mocker, capsys):
        ...
        mocker.patch("sales.app.workers.tasks.notify_scorecard", mock_task)
    ...
    def test_replay_scoring_enqueues_task(self, mocker, capsys):
        ...
        mocker.patch("sales.app.workers.tasks.score_call", mock_task)
    ...
    def test_run_weekly_report_enqueues_task(self, mocker, capsys):
        ...
        mocker.patch("sales.app.workers.tasks.generate_weekly_report", mock_task)
...
def _mock_failed_calls_query(mocker, rows: list[dict]):
    ...
    mocker.patch("core.db.get_supabase", return_value=fake_db)
    return fake_db
